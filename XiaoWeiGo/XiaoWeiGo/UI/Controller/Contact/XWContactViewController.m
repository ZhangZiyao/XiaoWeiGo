...
//LLImagePickerControllerDelegate, LLChatShareDelegate,
...
//
//    self.refreshView.frame = CGRectMake(0, 0, ScreenWidth, 40);
//    self.voiceTipView.frame = CGRectMake(0, 64, ScreenWidth, 45);
//
...
//
//    self.refreshView.backgroundColor = bgColor;
//    isPulling = NO;
//    isLoading = NO;
//
...
//    self.tableViewHeightConstraint.constant = ScreenHeight - 64 - MAIN_BOTTOM_TABBAR_HEIGHT;
//
...
//
//    //派发下载错误提示
//    if (messageModel.messageDownloadStatus == kLLMessageDownloadStatusFailed && self.navigationController.visibleViewController == self) {
