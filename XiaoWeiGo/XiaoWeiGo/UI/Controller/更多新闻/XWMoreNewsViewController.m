...
@interface XWMoreNewsViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation XWMoreNewsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *cellid = @"moreneww";
    NewsViewCell *cell =[tableView dequeueReusableCellWithIdentifier:cellid];
    if (!cell) {
        cell = [[NewsViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellid];
    }
