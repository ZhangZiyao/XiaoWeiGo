...
//        _leftBtn.layer.borderColor = RGB_HEX(0x3b78d8, 1.0).CGColor;
...
//        _rightBtn.backgroundColor = RGB_HEX(0x3b78d8, 1.0);
//        _rightBtn.layer.cornerRadius = 6.0f;
//        _rightBtn.layer.masksToBounds = YES;
        _rightBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_rightBtn setTitleColor:RGB_HEX(0x3b78d8, 1.0) forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = RGB_HEX(0x3b78d8, 1.0);
