...
#define rowHeight 100*kScaleH
#define tableH 200*kScaleH
...
- (void)tapAction
{
    ...
    }else
    {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            CGRect frame = _menuTableView.frame;
            frame.size.height = self.listArr.count*100*kScaleH;
            [_menuTableView setFrame:frame];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, self.frame.size.width - 20, 44)];
        ...
        if (indexPath.row == 0) {
            UIImageView *line = [[UIImageView alloc]initWithFrame:CGRectMake(10, 100*kScaleH-0.5, cell.frame.size.width - 20, 0.5)];
