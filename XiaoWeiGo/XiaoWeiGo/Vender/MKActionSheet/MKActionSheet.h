...
@property (nonatomic, strong) UIColor *selectedButtonTitleColor; /*!< [default:RBGA(250.0f, 10.0f, 10.0f, 1.0f)]*/
...
//accessory
@property (nonatomic, assign) BOOL showAccessory;                  /*!< 是否显示箭头图片 */
@property (nonatomic, copy) NSString *accessoryImage;              /*!< Accessory image name [dafault:right] */
