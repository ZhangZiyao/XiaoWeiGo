 ...
 *  @param color    主颜色
 */
+ (UIImage *)SG_generateWithColorQRCodeData:(NSString *)data withBackgroundColor:(CIColor *)backGroundColor withMainColor:(CIColor *)color {
    // 1、创建滤镜对象
    CIFilter *filter = [CIFilter filterWithName:@"CIQRCodeGenerator"];
    ...
    [color_filter setValue:color forKey:@"inputColor1"];
