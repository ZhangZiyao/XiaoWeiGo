...
//- (void)pickerView:(WSDatePickerView *)pickerView didSelectedDateString:(NSString *)dateString;
- (void)pickerView:(WSDatePickerView *)pickerView didClickOkButtonWithDate:(NSDate *)selectedDate dateString:(NSString *)dateString;

@end

@interface WSDatePickerView : UIView

@property(nonatomic, weak)id<WSDatePickerDelegate>delegate;
/**
 *  确定按钮颜色
 */
